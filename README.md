...
- **Step 2.** Open the setting UI and enable the language server (search `"go.useLanguageServer"`). <!--TODO: delete in the next release-->
...
If you are new to Go, [this article](https://golang.org/doc/code.html) provides the overview on go code organization and basic `go` commands. <!-- TODO: write our own version of 'how to write go code' --> 
