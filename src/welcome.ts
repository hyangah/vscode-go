...
<li><a href="https://invite.slack.golangbridge.org/">Slack</a></li>
			...
			<div class="Announcement">
				...
				<p>Telemetry uploading is off by default</b> even when Visual Studio Code's telemetry setting is enabled.
				Go Telemetry needs to be enabled with the following command</b>:
				<br>
				...
				<p>
				If we get enough adoption, this data can significantly advance the pace of the go plugin and gopls development and help us meet a higher standard of reliability.
